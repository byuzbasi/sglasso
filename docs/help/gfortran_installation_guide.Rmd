...
Some R packages (e.g., `sglasso`, `brms`, `RcppArmadillo`) include source code written in C++ or Fortran. To compile these packages from source, your system must have a working **Fortran compiler**, specifically `gfortran`.
